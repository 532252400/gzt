...
ws1.cell(2, 1, "TEST001"); ws1.cell(2, 2, "东北部中心1"); ws1.cell(2, 3, "FedEx")
...
ws5.cell(2, 1, "TEST001"); ws5.cell(2, 2, 10); ws5.cell(2, 3, 100.5); ws5.cell(2, 4, 2.5); ws5.cell(2, 5, "A")

test_file = "C:/Users/pc/ZCodeProject/test/uploads/test_upload.xlsx"
wb.save(test_file)
print(f"Test file created: {test_file}")

def test_action(port, action):
    ...
    try:
        ...
        s = result.get("status", "?")
        m = str(result.get("message", ""))[:200]
        print(f'  [TEST] {action:10s}: status={s}')
        print(f'         msg={m}')
    except Exception as e:
        print(f'  [TEST] {action:10s}: ERROR - {e}')

# Test all 5 features on BOTH versions
print("\n=== 测试版 (8933) ===")
for act in ['lbl100', 'lbl30', 'us', 'ca', 'rc']:
    test_action(8933, act)

print("\n=== 稳定版 (8932) ===")
for act in ['lbl100', 'lbl30', 'us', 'ca', 'rc']:
    test_action(8932, act)
